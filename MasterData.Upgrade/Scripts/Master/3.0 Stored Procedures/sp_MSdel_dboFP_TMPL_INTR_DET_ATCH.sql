IF  EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_MSdel_dboFP_TMPL_INTR_DET_ATCH]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[sp_MSdel_dboFP_TMPL_INTR_DET_ATCH]
GO
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[TMPL_INTR_DET_ATCH_ID] = ' + convert(nvarchar(100),@TMPL_INTR_ATCH_ID,1) + ', '
