/****** Object:  StoredProcedure [dbo].[sp_MSdel_dboFP_TMPL_OVRD_ATCH]    Script Date: 3/9/2020 4:05:47 PM ******/
SET ANSI_NULLS ON
GO
				...
				if @@microsoftversion>0x07320000
					Begin
						...
						Begin
							...
							set @primarykey_text = @primarykey_text + '[TMPL_OVRD_ATCH_ID] = ' + convert(nvarchar(100),@c1,1) + ', '
