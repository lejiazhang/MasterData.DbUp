...
create procedure [dbo].[sp_MSdel_dboASET_COND_TYPE_CODE]
		@pkc1 varchar(10)
as
		...
		if @@rowcount = 0
			if @@microsoftversion>0x07320000
				Begin
					...
					exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[ASET_COND_TYPE_CODE]', @param2=@primarykey_text, @param3=13234
				End
	END
end  
